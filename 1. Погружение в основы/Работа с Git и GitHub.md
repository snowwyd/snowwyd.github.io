...
permalink: /1. Погружение в основы/Backend/Работа с Git и GitHub/
---
### Цель
---
Тебе обязательно нужно научиться работать с Git. Его нечасто спрашивают на собеседованиях, но без него ты не сможешь нормально работать дальше. Возвращайся на этот раздел каждый раз, как будешь разрабатывать свой проект.
