...
permalink: /1. Погружение в основы/Backend/Связывание микросервисов/
---
### Цель
---
В этом разделе будет небольшая справка с примером, как подсоединить один микросервис к другому. Тебе это нужно для задания из главы по уже твоему проекту. А связывание микросервисов - это критически важный навык программиста на Go
