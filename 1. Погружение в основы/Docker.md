...
layout: default
title: Docker
permalink: /1. Погружение в основы/Backend/Docker/
---
### Цель
---
Тебе нужно понимать, для чего нужен Docker. Он критически важен для подключения к сервису таких модулей, как: базы данных, кэш, брокеры сообщений, другие микросервисы. Также необходим для запуска твоего сервиса у другого разработчика на другом устройстве. Если у тебя вопрос, что такое кэш и брокеры - пока что забей на них. Docker довольно часто спрашивают на собеседованиях, а на работе он жизненно необходим.
